...
#ifndef CODA_IO_BINARYDECODER_H
#define CODA_IO_BINARYDECODER_H 1
...
/**
 * Decoder that deserializes from binary format.
 */
class BinaryDecoder : public AbstractDecoder {
public:
  BinaryDecoder(std::istream& strm, runtime::TypeRegistry* typeRegistry, const std::string& srcPath)
